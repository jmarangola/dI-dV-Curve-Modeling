% Cannot reference subfunctions in Matlab so this P(E) integral must be
% standalone to plot Tunneling rate using par proccessing.

function out = int_Ppar(E) % returns P(E) for any arbitrary E (integrated with respect to t)
    hbar = 1.0545718e-34; 
    h = 6.62607015e-34;
    dx_t = .01;
    tbounds = -20:dx_t:20;
